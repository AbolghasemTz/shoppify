...
const TabVegetable = () => {
  return (
    <div className="grid grid-cols-12 gap-x-4 gap-y-2 ">
      {ProductsData.vegetable.map((item) => {
        return (
          <div
            key={item.id}
            className="relative md:col-span-6 col-span-11 h-auto border border-gray-300 rounded-lg overflow-hidden shadow-md"
          >
